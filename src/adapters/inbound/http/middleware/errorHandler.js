...
function normalizeError(error) {
  ...
  if (error.code === 'ER_DUP_ENTRY') return new ConflictError('Ya existe un registro con esos datos');
  if (error.code?.startsWith('ER_') || error.code === 'ECONNREFUSED') return new DatabaseError();
